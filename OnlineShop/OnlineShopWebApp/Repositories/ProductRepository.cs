...
namespace OnlineShopWebApp.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        {
            products.Add(new Product("An Epic Journey to the Center of the Milky Way Galaxy", 1000, "Путешествие к центру галактики Млечный путь может - это возможность расширить границы нашего осознания и обрести новые глубокие знания о природе сущего. Ведь исследование галактики, в которой мы существуем, представляет собой уникальное отражение нашей внутренней духовной странности и устремленности. " +
            ...
            products.Add(new Product("Journey to the constellation Centaurus", 500, "Путешествие к созвездию Центавра - это погружение в неизведанные глубины космоса и духовного самосознания. " +
            ...
            products.Add(new Product("Journey to Andromeda", 3000, "Путешествие к Андромеде - это погружение в мистические глубины космоса и возможность расширить границы нашего понимания и воображения. " +
